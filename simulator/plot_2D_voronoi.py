...
class DrawVoronoi():
    ...
    def set_roi_vertices(self, roi_vertices): self.__roi_vertices = roi_vertices.copy()
    def set_region_num(self, region_num): self.__region_num = region_num
    def set_color_idx(self, color_idx): self.__color_idx = color_idx
